...
| **B-25** | 雙語 i18n(en/zh UI 切換)— Multi-language Tier 2 promote 評估(建 dictionary + locale state + 全站 UI string externalize + 切換 UI + 新 i18n dependency 如 next-intl) | `候選` | **需 draft ADR + Chris approve**(H4 Multi-language Tier 2 + H1 架構 + H2 新 dependency);CH-023 已把 source language 統一為英文做 externalize 地基 | architecture.md §11 / CLAUDE.md §5.4 H4 / [CH-023 §6](../03-implementation/changes/CH-023-unify-frontend-ui-language-english/spec.md) |

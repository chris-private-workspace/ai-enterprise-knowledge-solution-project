...
status: active                     # `active` from 2026-05-16 kickoff(user directive「現在我們可以先把 design-mockups 的內容 先進行實作」+ AskUserQuestion answer = W19 audit-and-adr-draft phase folder kickoff;same pattern as W17 D0 / W18 D0)
spec_refs:

...
> **Mandatory for Sev1 / Sev2;encouraged for recurring patterns**(per `PROCESS.md §4.5`)。
...
| 3 | {Monitoring / alerting} | ... | ... | C07 | Open |
| 4 | {Documentation update} | ... | ... | ... | Open |

## 8. Risk Register Update

- New risk added to [`RISK_REGISTER.md`](../../../01-planning/RISK_REGISTER.md):**R{N}**(if pattern is new)
- Existing risk severity / probability updated:R{N}(if existing risk now confirmed by this incident)

## 9. Component Design Note Updates

- `components/C{NN}-*.md`:edge case section enriched(per CC-5 v1-active);status bump if material

---

**Sign-off**:{Author} | Date:YYYY-MM-DD
**Reviewed by**:{Chris / SME} | Date:YYYY-MM-DD

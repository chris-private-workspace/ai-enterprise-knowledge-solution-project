...
ADR 文件位置:`docs/adr/NNNN-short-title.md`,NNNN 係 4-digit zero-padded sequential。

頭 11 個 ADR 由 v5 §13 Decision Log promote 而來,將喺 W2 框架完成後 batch 創建。新 ADR 由 NNNN=0012 開始。
